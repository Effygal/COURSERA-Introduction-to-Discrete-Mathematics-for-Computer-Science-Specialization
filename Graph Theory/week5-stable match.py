...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  9 11:07:13 2020
...
# Do not change the function definition line.
    ...
    while unmarriedMen:
        ...
        if currentHusband == None:
            ...
            currentSpouse = herPreferences.index(currentHusband)
            heRank = herPreferences.index(he)
            if currentSpouse > heRank:
                womanSpouse[she] = he
                manSpouse[he] = she
                nextManChoice[he] += 1
                unmarriedMen.remove(he)
...
#print(stableMatching(3, [ [0,1,2], [1,0,2], [1,2,0] ], [ [0,1,2], [1,0,2], [1,2,0] ]))
